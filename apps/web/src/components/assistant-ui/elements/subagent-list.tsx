  ...
  return (
    ...
    >
          ...
          >
            <div className="flex items-center gap-2">
              {done ? (
                ...
                <AgentLoader kind="square" size={14} label={`${agent.name} active`} />
              )}
            ...
            <span className="bg-foreground/[0.06] h-[3px] w-full overflow-hidden rounded-full">
              <span
                className={cn(
                  ...
                  done ? "bg-success/70" : "bg-foreground/60",
                )}
      ...
      {showSummary && (
        ...
        >
          <div className="flex items-center gap-2">
            <AgentLoader kind="triangle" size={14} label={`${summaryAgent.name} active`} />
            <span className="flex-1 truncate text-[13.5px]">
              {summaryAgent.name}
            </span>
            <span className={cn(mono, "text-foreground/35")}>
