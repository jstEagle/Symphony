          ...
          <AttachmentPreviewDialog>
            ...
            >
              ...
              {isUploading && (
                ...
                >
                  <AgentLoader kind="square" size={16} label="Uploading attachment" />
                </div>
              )}
              {isError && (
                <div
  ...
  return (
    <AttachmentPrimitive.Remove
      render={
        <TooltipIconButton
          tooltip="Remove file"
          className="aui-attachment-tile-remove absolute end-1 top-1 size-5 rounded-full bg-[var(--overlay)]! text-[var(--overlay-foreground)] after:absolute after:-inset-1.5 hover:opacity-90 hover:text-[var(--overlay-foreground)]! active:scale-[0.96] motion-reduce:transition-none"
          side="top"
        />
      }
    >
      <X className="aui-attachment-remove-icon size-3" />
    </AttachmentPrimitive.Remove>
  );
};
    ...
    <ComposerPrimitive.AddAttachment
      render={
        <TooltipIconButton
          ...
          variant="ghost"
          size="icon"
          className="aui-composer-add-attachment text-muted-foreground hover:text-foreground size-8 rounded-md"
          aria-label="Add Attachment"
        />
      }
    >
      <Plus className="aui-attachment-add-icon size-4" />
    </ComposerPrimitive.AddAttachment>
  );
};
