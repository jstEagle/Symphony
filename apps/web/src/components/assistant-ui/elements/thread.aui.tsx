...
const ThreadHistorySkeleton: FC = () => (
  ...
  >
    ...
    <div className="flex items-center gap-2 text-xs text-muted-foreground">
      <AgentLoader kind="circular" size={16} label="Loading conversation" />
  ...
  return (
    ...
    >
      <ThreadPrimitive.Viewport
        ...
        className="relative flex min-h-0 flex-1 flex-col overflow-x-auto overflow-y-scroll overscroll-contain"
      >
        <div
          className={cn(
        ...
        >
          ...
          <div
            ...
            className="mb-4 flex flex-col gap-y-6 empty:hidden"
          >
...
const Composer: FC<{ autoFocus: boolean }> = ({ autoFocus }) => {
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative w-full">
      <ComposerPrimitive.AttachmentDropzone
        render={
          <div
            data-slot="aui_composer-shell"
            className="border-border/70 focus-within:border-foreground/25 data-[dragging=true]:border-foreground/40 flex w-full cursor-text flex-col gap-2 rounded-lg border bg-background px-2 py-2 transition-[border-color] data-[dragging=true]:border-dashed"
          />
        }
      >
        <ComposerAttachments />
        <ComposerPrimitive.Input
          placeholder="Message"
          className="aui-composer-input caret-foreground placeholder:text-muted-foreground/60 max-h-48 min-h-8 w-full resize-none bg-transparent px-2 py-1.5 text-sm leading-5 outline-none"
          rows={1}
          autoFocus={autoFocus}
          enterKeyHint="send"
...
const ComposerAction: FC = () => {
  return (
    <div className="aui-composer-action-wrapper flex shrink-0 items-center">
        ...
        <ComposerPrimitive.Send
          render={
            <TooltipIconButton
              ...
              variant="ghost"
              size="icon"
              className="aui-composer-send size-8 text-foreground"
  ...
  return (
    ...
    >
      ...
      <AuiIf condition={(s) => s.thread.capabilities.reload}>
        <ActionBarPrimitive.Reload render={<TooltipIconButton tooltip="Regenerate" />}><ArrowsClockwise /></ActionBarPrimitive.Reload>
      </AuiIf>
      <ActionBarMorePrimitive.Root>
        <ActionBarMorePrimitive.Trigger render={<TooltipIconButton tooltip="More" className="data-[state=open]:bg-accent" />}><DotsThree /></ActionBarMorePrimitive.Trigger>
        ...
        >
          <ActionBarPrimitive.ExportMarkdown render={<ActionBarMorePrimitive.Item className="aui-action-bar-more-item hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground flex cursor-pointer items-center gap-2 rounded-lg px-2.5 py-1.5 text-sm outline-none select-none" />}><DownloadSimple className="size-4" />Export as Markdown
  ...
  return (
    ...
    >
      <AuiIf condition={(s) => s.thread.capabilities.edit}>
        <ActionBarPrimitive.Edit render={<TooltipIconButton tooltip="Edit" className="aui-user-action-edit" />}><PencilSimple /></ActionBarPrimitive.Edit>
      </AuiIf>
    </ActionBarPrimitive.Root>
  );
};
...
const BranchPicker: FC<BranchPickerPrimitive.Root.Props> = ({
  ...
  return (
    <BranchPickerPrimitive.Root
      ...
      {...rest}
    >
      <BranchPickerPrimitive.Previous render={<TooltipIconButton tooltip="Previous" />}><CaretLeft /></BranchPickerPrimitive.Previous>
      <span className="aui-branch-picker-state font-medium">
        <BranchPickerPrimitive.Number /> / <BranchPickerPrimitive.Count />
      </span>
      <BranchPickerPrimitive.Next render={<TooltipIconButton tooltip="Next" />}><CaretRight /></BranchPickerPrimitive.Next>
    </BranchPickerPrimitive.Root>
  );
};
