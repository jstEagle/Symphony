...
| Dynamic plans | Durable compare-and-swap revisions, typed mutations, dependency-aware scheduling, and objective fan-out materialization are implemented | Continue expanding typed replace/cancel/dependency/branch mutations and add composite fan-out item templates without weakening replay or capacity guarantees |
